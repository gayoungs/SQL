...
--TO_CHAR(날짜, 날짜포맷)
 ...
 SELECT TO_CHAR(SYSDATE, 'YYYY"년"MM"월"DD"일"') FROM DUAL; --포맷문자가 아닌경우는 ""로 묶어줍니다
 SELECT TO_CHAR(HIRE_DATE, 'YYYY-MM-DD') FROM EMPLOYEES;

--TO_CHAR(숫자,숫자포맷)
SELECT TO_CHAR(200000, '$999,999,999') FROM DUAL;
SELECT TO_CHAR(200000, '999999.999') FROM DUAL; --소수점자리 표현
...
--TO_DATE(문자,날짜포맷)
SELECT SYSDATE - '2023-05-16'SYSDATE FROM DUAL; --ERROR  문자인데 자동형변환불가
...
-------------------------------------------------------------------------
--NULL값에 대한 반환 NVL(컬럼, NULL일경우 처리)
