...
SELECT (SYSDATE - HIRE_DATE) / 7 AS WEEK FROM EMPLOYEES; --몇주가 지났는지
SELECT (SYSDATE - HIRE_DATE) / 365 AS YEAR FROM EMPLOYEES; --년도
SELECT TRUNC((SYSDATE - HIRE_DATE / 365) * 12 ) MONTH FROM EMPLOYEES; --달수
