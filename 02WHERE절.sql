...
SELECT * FROM EMPLOYEES WHERE JOB_ID = 'IT_PROG' OR JOB_ID = 'FI_MEG' AND SALARY >= 6000; --FI 중 6000이상인 사람 OR IT_PROG
SELECT * FROM EMPLOYEES WHERE( JOB_ID = 'IT_PROG' OR JOB_ID = 'FI_MEG') AND SALARY >= 6000;--FI, IT중 6000이상인 사람
